...
static int BMPisSupport(unsigned char *aFileHead); //根据文件头部判断是否支持该格式的解析
static int BMPGetPixelDatas (unsigned char *aFileHead, PT_PixelDatas tPixelDatas);
...
static int BMPisSupport(unsigned char *aFileHead){
...
static int BMPGetPixelDatas (unsigned char *aFileHead, PT_PixelDatas ptPixelDatas){
